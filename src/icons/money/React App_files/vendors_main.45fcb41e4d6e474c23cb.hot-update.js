...
class ArcElement extends Element {
  ...
  inRange(chartX, chartY, useFinalPosition) {
    ...
    const betweenAngles = circumference >= _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["T"] || Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["p"])(angle, startAngle, endAngle);
...
class LineElement extends Element {
  ...
  interpolate(point, property) {
    ...
    const segments = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aj"])(this, {
      property,
      start: value,
      end: value
    });
...
function _segments(line, target, property) {
  ...
  for (const segment of segments) {
    ...
    const targetSegments = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aj"])(target, bounds);

    for (const tgt of targetSegments) {
      const subBounds = getBounds(property, tpoints[tgt.start], tpoints[tgt.end], tgt.loop);

      const fillSources = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["at"])(segment, points, subBounds);
...
class Legend extends Element {
  ...
  adjustHitBoxes() {
    ...
    const rtlHelper = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["av"])(rtl, this.left, this.width);
  ...
  _draw() {
    ...
    const rtlHelper = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["av"])(opts.rtl, this.left, this.width);
    const labelFont = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["Y"])(labelOpts.font);
    const {
      color: fontColor,
      padding
    ...
    const drawLegendBox = function (x, y, legendItem) {
      ...
      if (labelOpts.usePointStyle) {
        ...
        const borderRadius = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["as"])(legendItem.borderRadius);
        ctx.beginPath();
    ...
    this.legendItems.forEach((legendItem, i) => {
      ...
      x = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["ax"])(textAlign, x + boxWidth + halfFontSize, isHorizontal ? x + width : this.right, opts.rtl);
  ...
  nearest(items, eventPosition) {
    ...
    for (i = 0, len = items.length; i < len; ++i) {
      ...
      if (el && el.hasValue()) {
        ...
        const d = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aA"])(eventPosition, center);
...
function getBackgroundPoint(options, size, alignment, chart) {
  ...
  const {
    ...
    bottomLeft,
    bottomRight
  } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["as"])(cornerRadius);
...
class Tooltip extends Element {
  ...
  drawTitle(pt, ctx, options) {
    ...
    if (length) {
      const rtlHelper = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["av"])(options.rtl, this.x, this.width);
  ...
  _drawColorBox(ctx, pt, i, rtlHelper, options) {
    ...
    if (options.usePointStyle) {
      ...
      const borderRadius = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["as"])(labelColors.borderRadius);
  ...
  drawBackground(pt, ctx, tooltipSize, options) {
    ...
    const {
      ...
      bottomLeft,
      bottomRight
    } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["as"])(options.cornerRadius);
    ctx.fillStyle = options.backgroundColor;
    ctx.strokeStyle = options.borderColor;
    ctx.lineWidth = options.borderWidth;
    ctx.beginPath();
...
function generateTicks$1(generationOptions, dataRange) {
  ...
  let spacing = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aC"])((rmax - rmin) / maxSpaces / unit) * unit;
  ...
  const decimalPlaces = Math.max(Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aF"])(spacing), Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aF"])(niceMin));
...
function addTick(ticks, time, timestamps) {
  if (!timestamps) {
    ...
    const {
      lo,
      hi
    } = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aI"])(timestamps, time);
...
class TimeScale extends Scale {
  ...
  buildTicks() {
    ...
    const ticks = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aH"])(timestamps, min, max);
...
function ChartComponent(_param, ref) {
  ...
  */
  ...
  var ref1 = _slicedToArray(Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])()),
      computedData = ref1[0],
...
function createTypedChart(type) {
  return /*#__PURE__*/Object(react__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(function (props, ref) {
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Chart, Object.assign({}, props, {
      ref: ref,
      type: type
    }));
  });
...
//# sourceMappingURL=vendors~main.45fcb41e4d6e474c23cb.hot-update.js.map